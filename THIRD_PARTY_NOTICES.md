...
| officeParser browser bundle | `webui/js/vendor/officeparser.iife.js` | [harshankur/officeParser](https://github.com/harshankur/officeParser) | MIT | NEEDS OWNER REVIEW | The bundle banner says `officeparser browser bundle`; embedded package data identifies Tesseract.js 7.0.0 and PDF.js 6.1.200, matching officeParser 7.0.0's dependency set. The officeParser version/build commit is not explicitly embedded, and the bundle was locally changed during attachment work. Record the exact upstream release/commit and build inputs before release. |
| officeParser bundled dependencies | Inside `webui/js/vendor/officeparser.iife.js` | [naptha/tesseract.js](https://github.com/naptha/tesseract.js), [mozilla/pdf.js](https://github.com/mozilla/pdf.js), [zloirock/core-js](https://github.com/zloirock/core-js) | Apache-2.0 / Apache-2.0 / MIT | NEEDS OWNER REVIEW | Embedded metadata identifies Tesseract.js 7.0.0, PDF.js 6.1.200, and core-js 3.49.0. The bundle does not include a complete consolidated notice for all dependencies; preserve their notices or ship a generated notice file when the exact bundle is pinned. |
...
check. Current unresolved items are recorded as `NEEDS OWNER REVIEW` rather
than blockers.
