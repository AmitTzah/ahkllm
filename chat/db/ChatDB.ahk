...
class ChatDB {
    ...
    static _CreateSchema() {
        ...
        if !hasProvider
            ChatDB.db.Exec("ALTER TABLE messages ADD COLUMN provider TEXT DEFAULT '';")
