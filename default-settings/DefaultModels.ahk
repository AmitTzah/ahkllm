...
models := Map(    ; -- DeepSeek --
    ...
    "deepseek/deepseek-v4-flash-vision-exp", {
        ...
        thinkingOff: "disabled",
        input: 0.14, cachedInput: 0.0028, output: 0.28, context: 1000000, reasoning: true, vision: true
    },
    ...
    "openai/gpt-5.6", {
        ...
        thinkingOff: "none",
        input: 4, cachedInput: 0.4, output: 20, context: 1050000, reasoning: true, vision: true
    },
    "openai/gpt-5.6-luna", {
        provider: "openai", api: "openai-completions",
        compat: Map("thinkingFormat", "openai", "supportsReasoningEffort", true, "supportsUsageInStreaming", true, "maxTokensField", "max_completion_tokens"),
