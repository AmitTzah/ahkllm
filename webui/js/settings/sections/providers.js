...
(function() {
  ...
  function addProvider() {
    ...
    card.innerHTML = '<div class="provider-card-header"><div class="provider-icon" style="background:' + colors.bg + ';color:' + colors.fg + ';">NP</div><span style="font-weight:600;">New Provider</span><button class="btn-sm danger" style="margin-left:auto;">Remove</button></div>' +
      '<div class="field"><label class="field-label">Display Name</label><input type="text" value="New Provider" data-field="displayName"></div>' +
      '<div class="field"><label class="field-label">Chat Endpoint</label><input type="text" placeholder="https://..." data-field="endpoint"></div>' +
      '<div class="field"><label class="field-label">FIM Endpoint</label><input type="text" placeholder="https://..." data-field="fimEndpoint"></div>' +
      '<div class="field"><label class="field-label">API Key <span class="hint">env variable (preferred)</span></label><input type="text" placeholder="API_KEY" data-field="authEnvVar" style="font-family:var(--font-mono);font-size:12px;"><div class="field-hint">Set via: setx API_KEY your-key</div></div>' +
