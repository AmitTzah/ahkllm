...
(function(root, factory) {
  ...
  var messages = {
    ...
    'threadSettings': { dir: 'ahk->web', fields: ['model', 'systemMessage', 'reasoning', 'temperature', 'reasoningOverrideSet', 'temperatureOverrideSet', 'webSearch', 'fontSize', 'assistantName', 'assistantBaseModel', 'assistantDescription', 'thinkingLevels'], required: ['model'] },
    ...
    'updateModelSettings': { dir: 'web->ahk', fields: ['model', 'systemMessage', 'reasoning', 'temperature', 'reasoningOverrideSet', 'temperatureOverrideSet', 'webSearch'], required: ['model', 'systemMessage', 'reasoning', 'temperature', 'webSearch'] },
