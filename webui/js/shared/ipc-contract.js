...
(function(root, factory) {
  ...
  var messages = {
    ...
    'updateModelSettings': { dir: 'web->ahk', fields: ['model', 'systemMessage', 'reasoning', 'temperature', 'codeExecution', 'webSearch'], required: ['model', 'systemMessage', 'reasoning', 'temperature', 'codeExecution', 'webSearch'] },
